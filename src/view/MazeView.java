...
public final class MazeView extends JFrame {
    ...
    private JMenuBar createMenuBar() {
        ...
        instructions.addActionListener(_ -> showInstructions());
        about.addActionListener(_ -> showAbout());
    ...
    private void showInstructions() {
        final String msg = "<html><div style='width:350px'>"
                ...
                + "directions that have a door will be active.<br><br>" + "<b>Doors:</b><br>"
                + "&nbsp;&nbsp;\uD83D\uDFE1 <b>Yellow</b> \u2014 closed, "
                ...
                + "appear.<br><br>" + "<b>Losing:</b> If all paths to the exit are blocked by "
    ...
    private JButton createDirBtn(final String theTxt, final Direction theDir) {
        ...
        button.addActionListener(_ -> tryMove(theDir));
        return button;
    }
    ...
    private boolean canMove(final boolean theFree, final Direction theDir) {
        return theFree && myCurrentRoom != null && myCurrentRoom.hasDoor(theDir)
    ...
    private final class MazePanel extends JPanel {
        ...
        protected void paintComponent(final Graphics theGraphics) {
            ...
            graphics.fillOval(playerX - radius, playerY - radius, radius * HALF,
                    radius * HALF);
        ...
        private void drawAllDoors(final Graphics2D theG, final TriviaRoom theRoom,
                final int theX, final int theY, final int theSize, final int theMargin) {
        ...
        private void createMC(final MultipleChoiceQuestion theQ) {
            ...
            for (final String choice : opts) {
                ...
                radioButton.addActionListener(
                        _ -> myController.submitAnswer(choice, myDirection));
            }
            myAnswerArea.add(row);
        }
